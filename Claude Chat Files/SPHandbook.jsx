...
/* ============================================================================
   SP HANDBOOK — calm, editorial employee handbook & people directory.
...
const SECTIONS = {
  ...
  marketing: [ { key: "mkt-brand", name: "Brand", tag: "How SP looks and feels." }, { key: "mkt-content", name: "Content", tag: "The stories we tell." } ],
...
const EMPLOYEES = [
  { id: 1,  name: "Eleanor Voss",     dept: "management",  section: "m-exec",    title: "Chief Executive",        loc: "London",     ext: "100", g: "w", p: 68, motto: "Decide slowly, act once.", bio: "Eleanor has led SP since its founding, arriving by way of industrial design. She is known for long walks before large decisions and a steady, unhurried hand." },
  ...
  { id: 19, name: "Olivia Bergström", dept: "marketing",   section: "mkt-brand",     title: "Head of Marketing",     loc: "Copenhagen",ext: "220", g: "w", p: 8, motto: "Say less, mean more.", bio: "Olivia shapes how SP sounds in the world. She edits relentlessly and trusts white space." },
...
const emailOf  = (e) => `${e.name.toLowerCase().replace(/[^a-z ]/g, "").replace(/ /g, ".")}@sp.co`;
    ...
    <header className="mast">
      <div className="mast-inner">
        <div className="flex items-center gap-3">
          <span className="wordmark-dot" /><span className="wordmark">SP</span>
    ...
    <div className="screen-bg landing-bg min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center">
        <div className="page-pad w-full"><div className="mx-auto" style={{ maxWidth: 880 }}>
          ...
          <Reveal delay={420}><p className="lede mt-7" style={{ maxWidth: 540 }}>Browse by department, open a section, and flip through each colleague's profile — getting acquainted with how SP works, at your own pace.</p></Reveal>
        ...
        <Reveal delay={80} className="w-full" style={{ maxWidth: 420 }}>
          <div className="card login-card">
            ...
            <div className="mt-7 flex flex-col gap-4">
              <label className="field"><span className="field-label">Email</span><input type="email" className="field-input" placeholder="you@sp.co" value={email} onChange={(e) => setEmail(e.target.value)} /></label>
    ...
    <header className="m-head">
      <div className="m-head-left">
        {onBack ? <button className="m-iconbtn" onClick={onBack} aria-label="Back"><ChevronLeft size={20} /></button>
          : <span className="m-brand"><span className="wordmark-dot" /><span className="wordmark" style={{ fontSize: 12 }}>SP</span></span>}
      ...
      <div className="m-pad flex flex-col flex-1">
        <Reveal delay={60}>
          ...
          <div className="flex flex-col gap-4" style={{ marginTop: 26 }}>
            <label className="field"><span className="field-label">Email</span><input type="email" className="field-input m-field" placeholder="you@sp.co" value={email} onChange={(e) => setEmail(e.target.value)} /></label>
