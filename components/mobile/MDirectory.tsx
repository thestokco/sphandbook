...
import { deptName, sectionName, sectionsOf, sortLabel } from "@/lib/data";
import type { DeptKey, Employee, SortKey } from "@/lib/types";

export function MDirectory({
  dept,
  section,
  setSection,
  query,
  ...
  // Keep the selected chip visible in the horizontally-scrolling row.
  ...
  return (
    <div className="m-screen">
      ...
      <div className="m-subhead">
        ...
        <div style={{ display: "flex", gap: 9, alignItems: "center" }}>
          <div className="search-wrap" style={{ flex: 1 }}>
            ...
            <input
              ...
              placeholder="Search name, section, title…"
              value={query}
        ...
        <div className="m-chips" ref={chipsRef}>
          <button
        ...
        {results.length > 0 ? (
          ...
          <div className="empty" style={{ padding: "60px 10px" }}>
            ...
            <p className="lede mt-2" style={{ fontSize: 14 }}>
              Try a different name, section, or title.
            </p>
          </div>
        )}
      </div>
